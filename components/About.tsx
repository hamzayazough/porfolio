...
const profileData = {
  ...
  summary:
    "Software-engineering undergrad at Polytechnique Montréal (2022-2027) who loves building AI-powered products that shave hours off tedious workflows. Interned at Coveo (Fortune 500 search relevance ↑ 35%) and Beneva (audit platform for 400+ staff, processing time ↓ 40%). Finalist & hacker at AWS Hackathon, PolyHx, ConUHacks.",
}
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <div className="flex items-center gap-3 p-4 bg-slate-100 dark:bg-slate-800 rounded-lg">
                ...
                <a href={`mailto:${profileData.email}`} className="text-sm hover:text-blue-600 transition-colors">
                  {profileData.email}
                </a>
              </div>
